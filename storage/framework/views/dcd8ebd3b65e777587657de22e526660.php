    ...
    <div class="hero-bg min-h-screen">
            ...
            <div class="flex items-center justify-between px-4 md:px-6 py-4 max-w-5xl mx-auto">
                <a href="#" class="group flex items-center gap-3">
                    <span class="flex size-9 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-500 to-pink-500 text-sm font-bold text-white shadow-lg shadow-indigo-500/20 transition-transform duration-300 group-hover:scale-110 overflow-hidden">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile && $profile->avatar): ?>
                            <img src="<?php echo e(Storage::url($profile->avatar)); ?>" alt="<?php echo e($profile->name); ?>" class="size-full object-cover">
                        <?php else: ?>
                            <?php echo e($profile ? collect(preg_split('/\s+/', $profile->name))->map(fn($w) => strtoupper(substr($w, 0, 1)))->implode('') : 'P'); ?>
        ...
        <section id="home" class="relative flex flex-col items-center justify-center px-4 md:px-6 pt-20 md:pt-28 pb-20 text-center overflow-hidden">
            ...
            <div class="group relative mb-8">
                ...
                <div class="relative size-28 md:size-36 rounded-full bg-gradient-to-br from-indigo-500 to-pink-500 flex items-center justify-center overflow-hidden ring-4 ring-zinc-950 shadow-2xl shadow-indigo-500/30 transition-transform duration-500 hover:scale-105">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->avatar): ?>
                        <img src="<?php echo e(Storage::url($profile->avatar)); ?>" alt="<?php echo e($profile->name); ?>" class="size-full object-cover">
                    <?php else: ?>
                        <span class="text-3xl md:text-4xl font-bold text-white"><?php echo e(collect(preg_split('/\s+/', $profile->name))->map(fn($w) => strtoupper(substr($w, 0, 1)))->implode('')); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 tracking-tight">
                ...
                <br class="md:hidden">
                <span class="bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"><?php echo e($profile->name); ?></span>
            </h1>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->github_url || $profile->linkedin_url || $profile->email): ?>
            <div class="flex items-center gap-3 mt-10">
                <div class="h-px w-12 bg-gradient-to-r from-transparent to-zinc-700"></div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->github_url): ?>
                    <a href="<?php echo e($profile->github_url); ?>" target="_blank" class="flex size-10 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900/50 text-zinc-500 transition-all duration-300 hover:scale-110 hover:border-indigo-500 hover:bg-indigo-500/10 hover:text-indigo-400" title="GitHub">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->linkedin_url): ?>
                    <a href="<?php echo e($profile->linkedin_url); ?>" target="_blank" class="flex size-10 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900/50 text-zinc-500 transition-all duration-300 hover:scale-110 hover:border-indigo-500 hover:bg-indigo-500/10 hover:text-indigo-400" title="LinkedIn">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->email): ?>
                    <a href="mailto:<?php echo e($profile->email); ?>" class="flex size-10 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900/50 text-zinc-500 transition-all duration-300 hover:scale-110 hover:border-indigo-500 hover:bg-indigo-500/10 hover:text-indigo-400" title="Email">
        ...
        <section id="projects" class="px-4 md:px-6 py-16 max-w-5xl mx-auto" x-data="{ showAll: false }">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div
                    ...
                    x-show="showAll || <?php echo e($i < 2 ? 'true' : 'false'); ?>"
                >
                    <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r <?php echo e($project->color); ?> opacity-0 transition-opacity duration-300 group-hover/card:opacity-100"></div>
                    <div class="relative h-40 rounded-lg bg-gradient-to-br <?php echo e($project->color); ?> mb-4 flex items-center justify-center overflow-hidden">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->image): ?>
                            <img src="<?php echo e(Storage::url($project->image)); ?>" alt="<?php echo e($project->title); ?>" class="size-full object-cover">
                        <?php else: ?>
                    ...
                    <h3 class="font-semibold text-lg mb-2 text-zinc-100 group-hover/card:text-white transition-colors"><?php echo e($project->title); ?></h3>
                    <p class="text-sm text-zinc-400 mb-4 leading-relaxed"><?php echo e($project->description); ?></p>
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $project->tags ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <span class="rounded-full border border-zinc-700/50 bg-zinc-800/50 px-3 py-1 text-xs text-zinc-300 transition-colors group-hover/card:border-indigo-500/30 group-hover/card:text-indigo-300"><?php echo e($tag); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->demo_url): ?>
                        <a href="<?php echo e($project->demo_url); ?>" target="_blank" class="self-start sm:self-auto shrink-0 rounded-lg border border-zinc-700 px-4 py-2 text-xs font-medium text-zinc-300 transition-all hover:border-indigo-500 hover:bg-indigo-500/10 hover:text-indigo-400">
                            Demo →
                        </a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
            ...
            <div class="text-center mt-8">
                <button
                    ...
                    x-text="showAll ? 'Show Less' : 'Show All Projects (<?php echo e($projects->count()); ?>)'"
                ></button>
            </div>
        </section>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($experiences->isNotEmpty()): ?>
        <section id="experience" class="px-4 md:px-6 py-16 max-w-3xl mx-auto">
            <h2 class="text-xl md:text-2xl font-bold mb-8 text-center">
                <span class="gradient-text">Experience</span>
            </h2>
            <div class="space-y-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="relative flex gap-6 group transition-all duration-500" style="transition-delay: <?php echo e($i * 150); ?>ms">
                    <div class="relative flex flex-col items-center">
                        <div class="z-10 flex size-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-pink-500 text-sm font-bold text-white shadow-lg shadow-indigo-500/20">
                            <?php echo e(substr($exp->company, 0, 1)); ?>
                    ...
                    <div class="group/card relative mb-8 flex-1 rounded-xl border border-zinc-800 bg-zinc-900/80 p-4 md:p-5 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:border-indigo-500/50 hover:shadow-xl hover:shadow-indigo-500/5">
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-3">
                            <div>
                                <h3 class="text-base md:text-lg font-bold bg-gradient-to-r from-indigo-400 to-pink-400 bg-clip-text text-transparent"><?php echo e($exp->role); ?></h3>
                                <p class="text-sm text-zinc-300"><?php echo e($exp->company); ?></p>
                            </div>
                            <span class="self-start shrink-0 rounded-full bg-zinc-800/80 px-3 py-1 text-xs text-zinc-500"><?php echo e($exp->period); ?></span>
                        </div>
                        <p class="mb-4 text-sm leading-relaxed text-zinc-400"><?php echo e($exp->description); ?></p>
                        <div class="flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $exp->tags ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <span class="rounded-full border border-zinc-700/50 bg-zinc-800/50 px-3 py-1 text-xs text-zinc-300 transition-colors group-hover/card:border-indigo-500/30 group-hover/card:text-indigo-300"><?php echo e($tag); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($skills)): ?>
        <section id="skills" class="px-4 md:px-6 py-16 max-w-5xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <span class="rounded-lg border border-zinc-800 bg-zinc-900 px-5 py-3 text-sm font-medium transition-all duration-300 hover:scale-105 hover:border-indigo-500 hover:text-indigo-400 hover:shadow-lg hover:shadow-indigo-500/5"><?php echo e($skill); ?></span>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </section>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-4292038861-0', $__key);
...
?>
        ...
        <footer class="border-t border-zinc-800 px-6 py-6 text-center text-sm text-zinc-500">
            &copy; <?php echo e(date('Y')); ?> <?php echo e($profile->name); ?>. Built with Laravel + Livewire.
        </footer>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
...
<?php /**PATH C:\laragon\www\portfolio-app-v2\resources\views/portfolio.blade.php ENDPATH**/ ?>